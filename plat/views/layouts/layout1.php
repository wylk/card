            ...
            <div class="tpl-left-nav-list">
                <ul class="tpl-left-nav-menu">
                    <li class="tpl-left-nav-item">
                        <a href="<?php echo yii\helpers\Url::to(['default/homepage'])?>" class="nav-link active">
                            <i class="am-icon-home"></i>
                            <span>首页</span>
                        </a>
                    </li>
                    <li class="tpl-left-nav-item">
                        <a href="<?php echo yii\helpers\Url::to(['default/create_card'])?>" class="nav-link tpl-left-nav-link-list">
                            <i class="am-icon-plus"></i>
                            <span>发卡</span>
                            <i class="tpl-left-nav-content tpl-badge-danger">1</i>
                        </a>
                    </li>
                    <li class="tpl-left-nav-item">
                        <a href="<?php echo yii\helpers\Url::to(['default/card_list'])?>" class="nav-link tpl-left-nav-link-list">
                            <i class="am-icon-location-arrow"></i>
                            <span>发布的卡</span>
                            <i class="tpl-left-nav-content tpl-badge-danger">2</i>
                        </a>
                    </li>
                    <li class="tpl-left-nav-item">
                        <a href="<?php echo yii\helpers\Url::to(['default/create_ticket'])?>" class="nav-link tpl-left-nav-link-list">
                            <i class="am-icon-plus"></i>
                            <span>发券</span>
                    ...
                    <li class="tpl-left-nav-item">
                        <a href="<?php echo yii\helpers\Url::to(['default/ticket_list'])?>" class="nav-link tpl-left-nav-link-list">
                            <i class="am-icon-location-arrow"></i>
                            <span>发布的券</span>
                            <i class="tpl-left-nav-content tpl-badge-danger">0</i>
                        </a>
                    ...
                    <li class="tpl-left-nav-item">
                        <a href="<?php echo yii\helpers\Url::to(['default/card_varify'])?>" class="nav-link tpl-left-nav-link-list">
                    ...
                    <li class="tpl-left-nav-item">
                        ...
                        <ul class="tpl-left-nav-sub-menu" style="display: block;">
                            <li>
                                <a href="<?php echo yii\helpers\Url::to(['myself/received_card'])?>">
                                    <i class="am-icon-angle-right"></i>
                                    <span>领取的卡</span>
                                    <i class="am-icon-star tpl-left-nav-content-ico am-fr am-margin-right"></i>
                                </a>

                                <a href="<?php echo yii\helpers\Url::to(['myself/received_ticket'])?>">
                                    <i class="am-icon-angle-right"></i>
                                    <span>领取的券</span>
                                    <i class="tpl-left-nav-content tpl-badge-success">18</i>

                                    <a href="<?php echo yii\helpers\Url::to(['myself/checked_card'])?>">
                                        <i class="am-icon-angle-right"></i>
                                        <span>已核销的卡券</span>
                                        <i class="tpl-left-nav-content tpl-badge-primary">5</i>
...
<?php echo $content;?>
    ...
    <script src="assets/address-master/dist/address.js"></script>
