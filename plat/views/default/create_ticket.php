   <link rel="stylesheet" href="assets/address-master/dist/amazeui.address.css">
    ...
    <div class="tpl-content-wrapper">
            ...
            <ol class="am-breadcrumb">
                ...
                <li><a href="#">卡券列表</a></li>
                <li class="am-active">发券</li>　　<span style="color:red">注：</span>票券只能使用一次，卡片可以重复多次使用。
            </ol>
                        ...
                        <div class="am-u-sm-12 am-u-md-9">
                            <form class="am-form am-form-horizontal">
                                <div class="am-form-group">
                                    <label for="user-name" class="am-u-sm-3 am-form-label">票券名称</label>
                                    <div class="am-u-sm-9">
                                        <input type="text" id="user-name" placeholder="输入票券名称">
                                    </div>
                                </div>
                                ...
                                <div class="am-form-group">
                                    <label for="user-QQ" class="am-u-sm-3 am-form-label">发券数量</label>
                                    <div class="am-u-sm-9">
                                        <input type="text" id="user-QQ" placeholder="输入发券数量">
                                    </div>
                                </div>
                                <div class="am-form-group">
                                    <label for="user-weibo" class="am-u-sm-3 am-form-label">类型</label>
                                    <div class="am-u-sm-9">
                                    <div data-am-widget="tabs" class="am-tabs am-tabs-default">
                                    <ul class="am-tabs-nav am-cf">
                                        <li class="am-active"><a href="[data-tab-panel-0]">凭证类</a></li>
                                        <li class=""><a href="[data-tab-panel-1]">代金类</a></li>
                                        <li class=""><a href="[data-tab-panel-1]">折扣类</a></li>
                                        <li class=""><a href="[data-tab-panel-1]">满减类</a></li>
                                  </ul>
                                  ...
                                  <div data-tab-panel-1 class="am-tab-panel ">
                                    <div class="am-g">
                                     <div class="am-form-group">
                                        <label for="user-email" class="am-u-sm-3 am-form-label">代替金额</label>
                                        <div class="am-u-sm-9">
                                            <input type="text" id="user-email" placeholder="请输入代替金额最低0.01元">
                                        </div>
                                    </div>
                                    </div>
                                  </div>
                                  <div data-tab-panel-1 class="am-tab-panel ">
                                    <div class="am-g">
                                     <div class="am-form-group">
                                        <label for="user-email" class="am-u-sm-3 am-form-label">折扣比例</label>
                                        <div class="am-u-sm-9">
                                            <input type="text" id="user-email" placeholder="请输入大于0小于1的数，如7.5折输入0.75">
                                        </div>
                                    </div>
                                    </div>
                                  </div>
                                  <div data-tab-panel-1 class="am-tab-panel ">
                                    <div class="am-g">
                                     <div class="am-form-group">
                                        <label for="user-email" class="am-u-sm-3 am-form-label">满额</label>
                                        <div class="am-u-sm-9">
                                            <input type="text" id="user-email" placeholder="请输入满额最低0.01元">
                                        </div>
                                    </div>
                                    <div class="am-form-group">
                                        <label for="user-email" class="am-u-sm-3 am-form-label">减额</label>
                                        <div class="am-u-sm-9">
                                            <input type="text" id="user-email" placeholder="请输入减额最低0.01元">
                                        </div>
                                    </div>
                                    </div>
                                  </div>
                                ...
                                <div class="am-form-group">
                                    <label for="user-weibo" class="am-u-sm-3 am-form-label">领券方式</label>
                                    <div class="am-u-sm-9">
                                    <div data-am-widget="tabs" class="am-tabs am-tabs-default">
                                    <ul class="am-tabs-nav am-cf">
                                 ...
                                 <div class="am-form-group">
                                    <label for="user-weibo" class="am-u-sm-3 am-form-label">领券申请</label>
                                    <div class="am-u-sm-9">
                                 ...
                                 <div class="am-form-group">
                                    <label for="user-weibo" class="am-u-sm-3 am-form-label">领券信息</label>
                                    <div class="am-u-sm-9">
                                        <input type="text" id="user-weibo" placeholder="输入领券信息">
                                    </div>
                                </div>
                                 <div class="am-form-group">
                                    <label for="user-weibo" class="am-u-sm-3 am-form-label">领券限制</label>
                                    <div class="am-u-sm-9">
                                     ...
                                     <!--    <input type="text" id="user-weibo" placeholder="输入领券限制，默认0不限"> -->
                                    </div>
                                </div>
                                 <div class="am-form-group">
