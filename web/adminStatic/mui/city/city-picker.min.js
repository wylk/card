...
function(t) {
    ...
    function i(e, s) {
        ...
        i.DEFAULTS, t.isPlainObject(s) && s),
        this.active = !1,
        this.dems = [],
        this.needBlur = !1,
        this.init()
    }
    if ("undefined" == typeof e) throw new Error('The file "city-picker.data.js" must be included first!');
    var s = "citypicker",
    n = "change." + s,
    c = "province",
    o = "city",
    ...
    i.prototype = {
        ...
        render: function() {
            ...
            i = this.$element.attr("placeholder") || this.options.placeholder,//e.width
            s = '<span class="city-picker-span" style="' + this.getWidthStyle(window_width) + "height:" + e.height + "px;line-height:" + (e.height - 1) + 'px;overflow:hidden;">' + (i ? '<span class="placeholder">' + i + "</span>": "") + '<span class="title"></span><div class="arrow"></div></span>',
            n = '<div class="city-picker-dropdown" style="left:0px;top:100%;' + this.getWidthStyle(window_width, !0) + '"><div class="city-select-wrap"><div class="city-select-tab"><a class="active" data-count="province">省份</a>' + (this.includeDem("city") ? '<a data-count="city">城市</a>': "") + (this.includeDem("district") ? '<a data-count="district">区县</a>': "") + '</div><div class="city-select-content"><div class="city-select province" data-count="province"></div>' + (this.includeDem("city") ? '<div class="city-select city" data-count="city"></div>': "") + (this.includeDem("district") ? '<div class="city-select district" data-count="district"></div>': "") + "</div></div>";
        ...
        defineDems: function() {
            var e = !1;
            t.each([c, o, a], t.proxy(function(t, i) {
                e || this.dems.push(i),
        ...
        includeDem: function(e) {
            return - 1 !== t.inArray(e, this.dems)
        },
        getPosition: function() {
            ...
            e = s.height,
            i = s.width,
            this.options.responsive && (n = this.$element.offsetParent().width(), n && (i /= n, i > .99 && (i = 1), i = 100 * i + "%")),
            {
                top: t.top || 0,
                left: t.left || 0,
                height: 40,
        ...
        getSize: function(e) {
            ...
            }: (i = t("<div />").appendTo(t("body")), i.css({
                position: "absolute !important",
                visibility: "hidden !important",
                display: "block !important"
            }), s = e.clone().appendTo(i), n = {
                width: s.outerWidth(),
        ...
        getWidthStyle: function(e, i) {
            return this.options.responsive && !t.isNumeric(e) ? "width:" + e + ";": "width:" + (i ? Math.max(305, e) : e) + "px;"
        },
        bind: function() {
            var e = this;
            ...
            function(i) {
                var s, n = t(i.target);
                e.needBlur = !1,
                n.is(".select-item") ? (s = n.data("count"), e.open(s)) : e.$dropdown.is(":visible") ? e.close() : e.open()
            }).on("mousedown",
            function() {
                e.needBlur = !1
            }),
            ...
            function() {
                ...
                }), t(this).trigger(n), e.feedText(), e.feedVal(!0), c && e.close())
        ...
        feedText: function() {
            var t = this.getText();
            t ? (this.$textspan.find(">.placeholder").hide(), this.$textspan.find(">.title").html(this.getText()).show()) : (this.$textspan.find(">.placeholder").text(this.getPlaceHolder()).show(), this.$textspan.find(">.title").html("").hide())
        },
        getVal: function() {
            var e = "";
            return this.$dropdown.find(".city-select").each(function() {
        ...
        output: function(i) {
            var s, n, d, r, h = this.options,
            l = this["$" + i],
            p = i === c ? {}: [],
            u = null;
            l && l.length && (s = l.data("item"), r = (s ? s.address: null) || h[i], d = i === c ? 86 : i === o ? this.$province && this.$province.find(".active").data("code") : i === a ? this.$city && this.$city.find(".active").data("code") : d, n = t.isNumeric(d) ? e[d] : null, t.isPlainObject(n) && t.each(n,
            function(t, e) {
                var s;
                if (i === c) {
                    s = [];
                    for (var n = 0; n < e.length; n++) e[n].address === r && (u = {
                        code: e[n].code,
                        address: e[n].address
                    }),
                    s.push({
            ...
            }), l.html(i === c ? this.getProvinceList(p) : this.getList(p, i)), l.data("item", u))
        },
        ...
        simplize: function(t, e) {
            return t = t || "",
            e === c ? t.replace(/[省,市,自治区,壮族,回族,维吾尔]/g, "") : e === o ? t.replace(/[市,地区,回族,蒙古,苗族,白族,傣族,景颇族,藏族,彝族,壮族,傈僳族,布依族,侗族]/g, "").replace("哈萨克", "").replace("自治州", "").replace(/自治县/, "") : e === a ? t.length > 2 ? t.replace(/[市,区,县,旗]/g, "") : t: void 0
        },
        tab: function(t) {
    ...
    t.fn.citypicker = function(e) {
        ...
        return this.each(function() {
            ...
            if (!d) {
                ...
                a.data(s, d = new i(this, c))
            }
            "string" == typeof e && t.isFunction(o = d[e]) && o.apply(d, n)
        })
    },
